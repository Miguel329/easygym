<?php
	...
	$consultar1 = consultar("rutina","idRutina > 0");
   ...
   <div class="main">
          <div class="register-grids">
            ...
            <table width="626" border="0">
              <tr>
                <td width="267" height="341" valign="top">
				...
				?>
                <a href="" title="Enlace para direccionar a la página agregarrutina" class="header-text1">Agregar rutina</a>
                <br>
                <br>
                <a href="user_ejer.php" title="Enlace para direccionar a la página anterior" class="header-text1">Volver</a>
                </td>
                <td width="349">
                <?php echo (isset($_SESSION['error']))?"".$_SESSION['error']:"";?>
                <form method="post" action="../controller/registro_user_rutina.php">
                <table width="351" border="0">
                  <tr>
                    <td width="127" height="38"><div align="right">Nombre</div></td>
                    <td width="35">&nbsp;</td>
                    <td width="175">
                      <select name="idrutina" id="select">
                      <option value="">Seleccionar</option>
                        <?php
                        while($row1 = $consultar1 -> fetch_assoc())
                        {
                        ?>        
                            <option value="<?php echo $row1['idrutina'];?>"><?php echo $row1['Nombre'];?></option>
                        <?php
                        }
                        ?>
                      </select>
                  ...
                  <tr>
                    <td height="48" colspan="3" align="center"><input type="submit" name="button" id="button" value="Agregar">
                    </td>
                    </tr>
                </table>
