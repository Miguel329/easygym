          ...
          <div class="register-grids">
            ...
            <table width="1140" border="0">
              <tr>
				...
				{
				?>
                	<a href="galeria_ejer.php?id=<?php echo "".$url['idrutina']."";?>" class="header-text1" title="Enlace para direccionar a la página <?php echo "".$url['Nombre']."";?>" ><?php echo $url['Nombre']; ?></a>
                    <br>
                    <br>
                <?php	
				}
                ...
                <td width="740">                   
                  <table width="279" border="0">
					...
					{					
						...
						?>
                        <td width="198">
                        <iframe width="250" height="150" src="<?php echo $url_ejer['video']; ?>" frameborder="0" allowfullscreen></iframe>                        </td>
                        <td width="71">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <?php
						}					
					else
