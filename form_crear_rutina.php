    ...
    <div class="container">
   	  ...
   	  <table width="1058" height="326" border="0">
          ...
          <a href="lista_rutina.php" class="header-text1">Lista de Rutinas</a>
   	      ...
   	      <td width="836">
          <form method="post" action="../controller/registrar_rutina.php">
          	<table width="239" border="0">
              <tr>
                <td width="82" height="34"><div align="right">Nombre</div></td>
                <td width="14">&nbsp;</td>
                <td width="121"><input type="text" name="nombre" id="textfield"></td>
              </tr>
              <tr>
